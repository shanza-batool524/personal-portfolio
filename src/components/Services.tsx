...
function Services() { 
  ...
  const modalData=[
    {
      picture:["1.png","2.png","3.png","4.png"],
      Description:"A user-friendly e-commerce app designed to provide a seamless online shopping experience. The app allows users to effortlessly browse, search, and purchase products while ensuring secure payment integration for a smooth checkout process",
      name:"Native App",
      price:"$800"
    },
    {
      picture:["decoders.jpg","","",""],
      Description:"A user-friendly e-commerce app designed to provide a seamless online shopping experience. The app allows users to effortlessly browse, search, and purchase products while ensuring secure payment integration for a smooth checkout process",
      name:"Native App",
      price:"$800"
    },
...
>
  <div className="relative bg-white p-4 sm:p-6 rounded-lg w-full max-w-4xl h-full sm:h-auto flex flex-col sm:flex-row overflow-hidden">
    ...
    <div className="flex flex-col justify-center p-4 sm:p-10 bg-gray-100 w-full sm:w-1/2 h-1/2 sm:h-auto">
      <h2 className="text-xl sm:text-3xl font-semibold">{modalData[index].name}</h2>
      <p className="text-lg sm:text-2xl font-bold text-indigo-600 py-2 sm:py-4">
        {modalData[index].price}
      </p>
      <p className="text-gray-600 text-sm sm:text-base mt-2">{modalData[index].Description}</p>
    </div>
  </div>
</Dialog>
